...
import { a as CreateFreeBundlerOptions, F as FreeBundlerClient } from './types-BWgm35W7.cjs';
 ...
 * ```
 */
declare function createFreeBundler<chain extends Chain, account extends SmartAccount | undefined = undefined>(options: CreateFreeBundlerOptions<chain, account>): FreeBundlerClient<Transport, chain, account>;

export { createFreeBundler };
