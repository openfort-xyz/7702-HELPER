...
import "@oz-v5.4.0/utils/introspection/IERC165.sol";
import "@oz-v5.4.0/interfaces/IERC1271.sol";
import "@oz-v5.4.0/token/ERC1155/utils/ERC1155Holder.sol";
import "@oz-v5.4.0/token/ERC721/utils/ERC721Holder.sol";
import "@oz-v5.4.0/utils/cryptography/ECDSA.sol";
import "@account-abstraction-v8//core/Helpers.sol";
import "@account-abstraction-v8//core/BaseAccount.sol";
...
contract Simple7702Account is BaseAccount, IERC165, IERC1271, ERC1155Holder, ERC721Holder {
    ...
    function entryPoint() public pure override returns (IEntryPoint) {
        return IEntryPoint(0x43370900c8de573dB349BEd8DD53b4Ebd3Cce709);
    }
