...
export async function sendUserOperation(smartAccountClient: SmartAccountClient, userOperation: UserOperationWithEip7702Auth, signedAuthorization: SignAuthorizationReturnType) {
  return (await smartAccountClient.request({
